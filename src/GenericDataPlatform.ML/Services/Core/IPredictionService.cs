...
namespace GenericDataPlatform.ML.Services.Core
{
    ...
    public interface IPredictionService
    {
        ...
        /// </summary>
        /// <param name="id">ID of the prediction result</param>
        /// <returns>Prediction result, or null if not found</returns>
        Task<PredictionResponse?> GetPredictionResultAsync(string id);
