    ...
    public class PredictionService : IPredictionService
    {
        ...
        public async Task<BatchPredictionJob> ExecuteBatchPredictionJobAsync(BatchPredictionJob job)
        {
            ...
            try
            {
                ...
                // Load input data
                var inputData = await _storageService.GetDataAsync(job.Request.InputDataLocation);
                
                job.Status.Stats.TotalRecords = inputData.Count;
                ...
                await _storageService.SaveDataAsync(job.Request.OutputDataLocation, predictions);
